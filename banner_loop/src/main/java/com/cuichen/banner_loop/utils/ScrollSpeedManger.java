...
package com.cuichen.banner_loop.utils;
...
public class ScrollSpeedManger extends LinearLayoutManager {
    ...
    public ScrollSpeedManger(LoopViewPager banner, LinearLayoutManager linearLayoutManager) {
    ...
    public static void reflectLayoutManager(LoopViewPager banner) {
